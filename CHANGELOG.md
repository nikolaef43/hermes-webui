...
- Connection-lost banner styling now uses the active theme surface plus the selected palette accent tokens instead of an undefined dark fallback, so light/dark and skin preferences control the banner color consistently.
