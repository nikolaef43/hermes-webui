...
- Assistant responses now show a small "to question" jump button after the turn completes on desktop. Clicking it scrolls back to the user question that started the turn and briefly highlights that question. The affordance is hidden on narrow mobile viewports to avoid crowding the composer. Refs #2246.
